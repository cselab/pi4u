C  ---------------------------------------------------------------------
      SUBROUTINE PNDL3FF ( F, X, N, XL, XU, UH, FEPS, IPRINT, G,
     &                    HES, LD, NOC)
C, ISTIP, WTIP )
C  ---------------------------------------------------------------------
C
...
C
C  Output arguments:
C    G          Array containing the resulting gradient array.
...
C  ---------------------------------------------------------------------
      ...
      DIMENSION X(N), XL(N), XU(N), UH(N), G(N), HES(LD,N)
C
...
C
              NOC = NOC + 2
C            HES(I,I) = (F00 - 2.0D0*F1 + F2)/(HI**2)
              FORM = 'FD-FD'
C  ---------------------------------------------------------------------
