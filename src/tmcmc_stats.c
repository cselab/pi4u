...
/*** OPTIMIZATION ***/
int fminsearch(tmcmc_data_t *tmcmc_data, double *fj, int fn, double pj, double tol, double *xmin, double *fmin)
{
	...
	double Tol = tmcmc_data->data.options.Tol;
...
int fmincon(tmcmc_data_t *tmcmc_data, double *fj, int fn, double pj, double tol, double *xmin, double *fmin)
{
	int status;
...
{
	//double pflag = 0;
	double tolCOV = tmcmc_data->data.TolCOV;
	double *CoefVar = tmcmc_data->runinfo.CoefVar;
	double *p = tmcmc_data->runinfo.p;
	int *Num = tmcmc_data->data.Num;
	int *currentuniques = tmcmc_data->runinfo.currentuniques;
	double *logselection = tmcmc_data->runinfo.logselection;
